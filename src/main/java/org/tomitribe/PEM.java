...
public enum PEM {
    ...
    public static Certificate[] readCertificates(final InputStream is) throws IOException, CertificateException {
        ...
        for (final PEMObject object : readPEMObjects(is)) {
            ...
            switch (object.getPEMObjectType()) {
                ...
                case CERTIFICATE_X509:
                    ...
                    try {
                        result.add(cf.generateCertificate(new ByteArrayInputStream(object.getDerBytes())));
